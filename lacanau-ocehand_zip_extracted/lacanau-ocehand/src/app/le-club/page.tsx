...
export const metadata = buildMetadata({
  title: "Le club",
  description:
    "Né en 2017 à Lacanau, Lacanau Océhand est champion de France 2024. Découvrez l'histoire, le palmarès et l'équipe du club de handball.",
  path: "/le-club",
});
    ...
    <>
      ...
      <section className="container-x py-20 md:py-28">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal delay={0.08}>
            <div className="relative aspect-[4/3] overflow-hidden rounded-[var(--radius-lg)] border border-line">
              <Image
        ...
        <div className="mt-12 space-y-4">
          {palmares.map((p, i) => (
            <Reveal key={p.season} delay={i * 0.06}>
              <div className="grid gap-4 rounded-[var(--radius)] border border-line bg-white p-6 md:grid-cols-[200px_1fr] md:items-center md:p-8">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {salles.map((s, i) => (
              <Reveal key={s.name} delay={i * 0.06}>
                <div className="h-full overflow-hidden rounded-[var(--radius)] border border-line bg-paper">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {bureau.map((m, i) => (
            <Reveal key={m.id} delay={i * 0.05}>
              <div className="flex h-full items-center gap-4 rounded-[var(--radius)] border border-line bg-white p-5">
