    ...
    <>
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {trainable.map((t, i) => (
              <Reveal key={t.slug} delay={i * 0.05}>
                <div className="h-full rounded-[var(--radius)] border border-line bg-paper p-6">
      ...
      <section className="container-x py-20 md:py-28">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          ...
          {/* avantages */}
          <Reveal delay={0.08}>
            <div className="h-full rounded-[var(--radius)] border border-line bg-ocean-tint p-7 md:p-8">
              <h3 className="font-display text-lg uppercase tracking-tight text-ink">
                Inclus & avantages
              </h3>
