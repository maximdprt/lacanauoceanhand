...
function TeamCard({ team, color }: { team: Team; color: string }) {
  return (
    <div className="overflow-hidden rounded-[var(--radius)] border border-line bg-white transition hover:shadow-[var(--shadow-md)]">
...
function FeaturedTeam({
  ...
  return (
    <div
      className="overflow-hidden rounded-[var(--radius-lg)] border-2 bg-white"
