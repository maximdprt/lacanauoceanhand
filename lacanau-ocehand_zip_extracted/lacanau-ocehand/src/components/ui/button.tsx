...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-semibold transition-all duration-200 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        primary: "bg-ink text-white hover:bg-ocean rounded-full shadow-[var(--shadow-sm)]",
        ocean: "bg-ocean text-white hover:bg-ocean-deep rounded-full shadow-[var(--shadow-sm)]",
        ...
        light: "bg-white text-ink hover:bg-mist rounded-full shadow-[var(--shadow-sm)]",
      },
      size: {
        sm: "h-9 px-4 text-sm",
