    ...
    <section className="flex min-h-svh flex-col bg-ink">
      ...
      <div className="container-x shrink-0 px-4 pb-8 pt-1 md:pb-10 md:pt-2">
        <div className="mx-auto w-full max-w-3xl text-center">
          <h1
            className="hero-fade-up flex flex-col items-center gap-0.5 sm:gap-1"
            style={{ animationDelay: "0.1s" }}
          >
            <span className="whitespace-nowrap font-display text-[clamp(0.72rem,3.3vw,1.9rem)] font-black uppercase leading-none tracking-tight text-white">
          ...
          <p
            className="hero-fade-up mx-auto mt-3 max-w-lg text-pretty text-[clamp(0.82rem,1.5vw,0.95rem)] font-medium leading-relaxed text-white/75"
          ...
          <div
            className="hero-fade-up mt-5 flex flex-col gap-2.5 sm:flex-row sm:justify-center sm:gap-3"
          ...
          >
            {ctas.map(({ label, href, icon: Icon, primary }) => (
              <Link
                ...
                className={
                  primary
                    ? "btn-press group inline-flex h-12 w-full min-w-[200px] shrink-0 items-center justify-center gap-2 rounded-md bg-gold px-5 text-sm font-bold uppercase tracking-wide text-ink transition hover:bg-white sm:w-auto sm:text-base"
                    : "btn-press inline-flex h-12 w-full min-w-[200px] shrink-0 items-center justify-center gap-2 rounded-md border border-white/25 bg-white/5 px-5 text-sm font-bold uppercase tracking-wide text-white transition hover:border-white/40 hover:bg-white/10 sm:w-auto sm:text-base"
                }
              >
