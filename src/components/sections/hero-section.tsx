...
export function HeroSection() {
  return (
    <section className="flex min-h-svh flex-col bg-ink">
      ...
      <div className="relative min-h-[44svh] w-full flex-1 sm:min-h-[50svh]">
      ...
      <div className="container-x shrink-0 px-4 pb-10 pt-2 md:pb-12 md:pt-4">
        <div className="hero-fade-up mx-auto w-full max-w-3xl text-center">
          <h1 className="flex flex-col items-center gap-1 sm:gap-1.5">
            <span className="font-display text-[clamp(1.5rem,4.5vw,2.5rem)] font-black uppercase leading-none tracking-tight text-white">
              Club de handball
            </span>
            <span className="font-display text-[clamp(1.85rem,5.5vw,3.25rem)] font-black uppercase leading-none tracking-tight text-gold">
              à Lacanau
            </span>
          </h1>

          <p className="mx-auto mt-4 max-w-xl text-pretty text-[clamp(0.9rem,1.8vw,1.05rem)] font-medium leading-relaxed text-white/75">
